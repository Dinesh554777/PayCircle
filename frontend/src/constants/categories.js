...
export const CATEGORY_CONFIG = {
  ...
  Transport: { icon: Car, color: "#2563EB", soft: "rgba(37, 99, 235, 0.14)" },
  ...
  Healthcare: { icon: HeartPulse, color: "#DC2626", soft: "rgba(220, 38, 38, 0.14)" },
  Education: { icon: GraduationCap, color: "#14b8a6", soft: "rgba(20, 184, 166, 0.14)" },
  Travel: { icon: Plane, color: "#6C4BF4", soft: "rgba(108, 75, 244, 0.14)" },
